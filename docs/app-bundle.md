...
then install this release. Remove obsolete binaries: an old full-store writer
...
Complete the wrap-v2 step above if needed, then stop the existing agent and its
